    ...
    <div class="signup-page">
      <div class="carousel">
        <div class="carousel-inner">
          <div class="carousel-item" v-for="(image, index) in backgroundImages" :key="index" :class="{ active: index === currentIndex }">
            ...
            <div class="welcome-message">
              ...
              <h2 style="line-height: 1.5;">Get ready for your clinical exams with our expertly designed mock tests. Practice with realistic simulations and receive detailed performance insights to boost your confidence.</h2>
              <p style="line-height: 1.5;">Test your diagnosis ability and identify areas for improvement with our comprehensive mock tests.</p>
              <div class="pricing-table">
                <ul>
                  <li>price: <span>$10</span></li>
                </ul>
                <p>Secure payment via PayPal.</p>
                <button type="submit" class="btn" @click="startJourney">Start your journey to success today!</button>
              </div>
            </div>
          </div>
          </div>
